...
MODEL_TYPE = sys.argv[2] #'prob', 'drop', 'det', 'error_pred', error_pred_propper
...
if MODEL_TYPE == 'error_pred':
	...
	for i in range(0, EPOCHS, SAMPLING_INTERVAL):
		...
		convnet_errorpred.train(30,BATCH_SIZE, 30, disc_input_train, Error_train, disc_input_val, Error_val, disc_input_test, Error_test, True, True, i) #train error prediction network
