...
class ContextEncoder():
    def __init__(self):
        ...
        self.combined = Model(masked_img , [out_mean, out_b, valid])
        self.combined.compile(loss=['mse', 'mse', 'binary_crossentropy'],
            loss_weights=[0.999, 0.0, 0.001],
            optimizer=optimizer)
    ...
    def train(self, epochs, batch_size=64, sample_interval=500):
        ...
        for epoch in range(epochs):
            ...
            g_loss = self.combined.train_on_batch(masked_imgs, [missing_parts, missing_parts, valid])
