...
def show_snapshots(test_path, title):
    for epoch in snapshot_epochs[::-1]:
        plt.figure(figsize=(32,18)).suptitle('epoch {}, '.format(epoch)+title)
...
plt.figure(figsize=(32,18)).suptitle('different mathods similarity measure')
...
plt.figure(figsize=(32,18)).suptitle('interval error pred comparion how much is drin')
